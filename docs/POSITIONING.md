...
- Use **MCP** when **AI tools and editors** should read/write memory over the Model Context Protocol without you wrapping each call. See the [@memorynodeai/mcp-server package on npm](https://www.npmjs.com/package/@memorynodeai/mcp-server).
